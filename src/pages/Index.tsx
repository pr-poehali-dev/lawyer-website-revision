    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-start max-w-6xl mx-auto">
            ...
            <div className="flex justify-center lg:justify-end order-1 lg:order-2">
              <div className="relative w-full max-w-[280px] xs:max-w-xs sm:max-w-sm md:max-w-md lg:mt-16">
      ...
      <div className="fixed right-3 sm:right-4 md:right-6 bottom-6 sm:bottom-8 z-50 flex flex-col gap-3">
        <a
          ...
          className="group relative w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#2AABEE] hover:bg-[#229ED9] shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center hover:scale-110"
        >
          ...
          <span className="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-card border border-border text-foreground text-xs sm:text-sm px-3 py-1.5 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none shadow-md">
            Telegram
          </span>
        </a>
        ...
        <a
          ...
          className="group relative w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#0077FF] hover:bg-[#0066DD] shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center hover:scale-110"
        >
          <span className="text-white font-bold text-xs sm:text-sm tracking-tight">MAX</span>
          <span className="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-card border border-border text-foreground text-xs sm:text-sm px-3 py-1.5 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none shadow-md">
            MAX: +7 906 019-40-20
          </span>
        </a>
